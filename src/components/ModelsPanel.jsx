        ...
        <div className="h-full overflow-y-auto">
          ...
          <div className="bg-gradient-to-r from-[#0A2259] to-[#1a3668] text-white p-6 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              {/* Sección de Lotes con diseño similar a las casas */}
              <div className="bg-gradient-to-br from-white/95 to-white rounded-2xl p-5 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02] border border-white/50 relative overflow-hidden">

                {/* Lotes Header */}
                <div className="text-center pb-2 mb-4">
                  <h4 className="text-3xl md:text-4xl font-normal text-[#0A2259] uppercase tracking-wider mt-1" style={{ fontFamily: "Montserrat, Arial, sans-serif" }}>
                    LOTES
                  </h4>
                </div>
                ...
                {/* Specifications similar to models */}
                <div className="mb-6">
                ...
                <div className="bg-gray-50 rounded-lg p-3 mb-4 border border-gray-200">
                  <p className="text-gray-600 text-xs leading-relaxed text-center">
                    <span className="text-gray-500">*</span>Algunas ubicaciones pueden tener variaciones en sus medidas.
                  </p>
                </div>
