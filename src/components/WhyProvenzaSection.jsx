    ...
    >
      <div className="max-w-6xl mx-auto px-4 md:px-8">
        ...
        >
          ...
          >
            ¿POR QUÉ PROVENZA
            <span className="text-2xl md:text-4xl lg:text-5xl align-super">
              ®
            </span>
            ?
          </h2>
          ...
          >
            <div className="flex-shrink-0">
              <div className="w-20 h-20 md:w-24 md:h-24 border-2 border-[#0A2259] rounded-full flex items-center justify-center group hover:bg-[#0A2259] transition-all duration-500">
                <svg
                  className="w-10 h-10 md:w-12 md:h-12 text-[#0A2259] group-hover:text-white transition-colors duration-500"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
