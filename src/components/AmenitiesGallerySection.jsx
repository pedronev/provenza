  ...
  const amenities = [
    {
      ...
      description: "Área dedicada especialmente para el entretenimiento y desarrollo de los bebés y niños pequeños."
    },
    {
      id: 2,
      url: "https://images.unsplash.com/photo-1571902943202-507ec2618e8f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2075&q=80",
      title: "ALBERCA",
      subtitle: "Disfruta y relájate",
      description: "Amplia alberca para toda la familia con área de relajación y entretenimiento acuático."
    },
    {
      id: 3,
      url: "https://images.unsplash.com/photo-1576013551627-0cc20b96c2a7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
      title: "ÁREA DE PARRILLAS",
      subtitle: "Espacios para convivir",
      description: "Zona equipada con parrillas y asadores para reuniones familiares y eventos especiales."
    },
    {
      id: 4,
      ...
      subtitle: "Mantente activo",
      description: "Equipamiento completo para ejercitarte al aire libre en un ambiente natural y saludable."
    }
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        >
          <p className="text-lg md:text-xl text-white/90 max-w-4xl mx-auto leading-relaxed">
            PROVENZA<sup className="text-sm">®</sup> CUENTA CON AMENIDADES QUE MEJORARÁN TU CALIDAD DE VIDA.
          </p>
        </div>
          ...
          <div className="relative h-[400px] md:h-[500px] rounded-3xl overflow-hidden shadow-2xl">
            {amenities.map((amenity, index) => (
              ...
              >
                ...
                {/* Content Overlay */}
                <div className={`absolute inset-0 flex items-end transition-all duration-700 delay-300 ${
                  index === currentIndex 
            ...
            <div className="absolute bottom-0 left-0 right-0 h-1 bg-white/20">
              <div 
                ...
                style={{ width: `${((currentIndex + 1) / amenities.length) * 100}%` }}
              />
            </div>
          </div>
